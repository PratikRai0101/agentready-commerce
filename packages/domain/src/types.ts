...
export const ALLOWED_TRANSITIONS: Record<OrderState, OrderState[]> = {
  ...
  AWAITING_APPROVAL: ["APPROVED", "EXPIRED", "REAPPROVAL_REQUIRED"],
  ...
  PAID_VERIFIED: ["FULFILMENT_PENDING", "FULFILMENT_FAILED", "REFUNDED"],
  FULFILMENT_PENDING: ["FULFILLED", "FULFILMENT_FAILED"],
  FULFILLED: [],
  EXPIRED: [],
  REAPPROVAL_REQUIRED: ["AWAITING_APPROVAL", "APPROVED", "EXPIRED"],
